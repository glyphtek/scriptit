 ...
 */
export async function runTUI(configPath, initialScriptsDir, initialTmpDir, initialEnv, initialConfigValues, emitter) {
    try {
        ...
        let currentFocus = "fileList";
        let isConfigVisible = false;
        let isFileListVisible = true;
        let currentScriptPaths = [];
        // --- Control Panel ---
        const controlPanel = blessed.box({
            ...
            width: "100%",
            height: 1,
            content: " [C]onfig | [F]iles | [Tab] Focus | [Enter] Run | [j/k] Navigate | [R]efresh | [Q]uit ",
            style: {
                fg: "white",
                bg: "blue",
            },
        ...
        async function populateFileList() {
            ...
            try {
                ...
                const scriptPaths = await getScriptFiles(initialScriptsDir, excludePatterns);
        ...
        async function executeSelectedScript() {
            ...
            try {
                ...
                if (typeof scriptModule.default === "function") {
                    ...
                    throw new Error("Script must export either an 'execute' function or a 'default' function");
                }
                const context = {
                    env: initialEnv,
        ...
        updateLayout();
        setFocus("fileList");
        outputLog.log("TUI initialized. Use [↑↓] or [j/k] to navigate, [Tab] to switch focus, [Enter] to run scripts, [Q] to quit.");
        screen.render();
    }
    catch (error) {
...
//# sourceMappingURL=blessed-ui.js.map